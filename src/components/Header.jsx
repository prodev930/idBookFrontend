...
const pages = ["","Become A Pro","","",""];
const settings = ['Profile', 'Account', 'Dashboard', 'Logout'];
const tabs = ["","Become A Pro","","","",""];
            ...
            > 
              ...
              >
                ...
                {index === 0 && <ListItemIcon> 
                  <Button variant="text" endIcon={<KeyboardArrowDownIcon />} sx={{color:"black", textTransform: 'none'}}>
                  <Link to="/" style={{textDecoration: 'none',  color: 'inherit'}}
  rel="noopener noreferrer">                  
  Home </Link>
</Button>
                ...
                {index === 1}
                {index === 2 &&  <Link to="/franchise" style={{textDecoration: 'none',  color: 'inherit'}}
  rel="noopener noreferrer">                  
...
{index === 3 && <ListItemIcon>  <Button
        ...
        onClick={handleClick}
        sx={{paddingLeft:'0', textTransform: 'none', color:'black'}}      
      > 
          24/7 Support 
      </Button>
      <Menu
      ...
      >
        <MenuItem onClick={handleClose}> <Button sx={{color:'black'}} className='ts-text' variant="text" startIcon={<CallIcon />}>
        +91 8645663143

</Button>
</MenuItem>
        <MenuItem onClick={handleClose}><Button sx={{color:'black'}} className='ts-text' variant="text" startIcon={<WhatsAppIcon />}>
        +91 8800150924
</Button></MenuItem>
              ...
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                ...
                className='btn-grad'> <Link to="/login" style={{textDecoration: 'none',  color: 'inherit'}}
                rel="noopener noreferrer">
          ...
          >
            <div className="logo-label">
            <img src={idblogo} alt="Logo" className="logo-image" style={{maxWidth:'150px', maxHeight:'33px'}} />
             </div>
          </Typography>
            ...
            {pages.map((page,index) => (
              ...
              >
                ...
                {index === 0 && <ListItemIcon> 
                  ...
                  <Link to="/" style={{textDecoration: 'none',  color: 'inherit', textTransform: 'none'}}
 rel="noopener noreferrer">                  
  Home </Link>
</Button>
                  </ListItemIcon>}
...
{index === 3 && <ListItemIcon>  <Button
      ...
      >
        <MenuItem onClick={handleClose}> <Button sx={{color:'black'}} variant="text" startIcon={<CallIcon />}>
        +91 8645663143

</Button>
</MenuItem>
        <MenuItem onClick={handleClose}><Button sx={{color:'black'}} variant="text" startIcon={<WhatsAppIcon />}>
        +91 8800150924
</Button></MenuItem>
