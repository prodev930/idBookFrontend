...
import DayPicker from '../Images/DayPicker.png';
...
>
  ...
  <Grid item xs={12} sm={6} md={2} sx={{marginLeft:"0%"}}>
     <img src={search} />
  </Grid>
</Grid>
...
{/* <Grid item xs={12} sm={12} sx={{justifyContent:"center",marginTop:"2%",
          ...
          <Grid item xs={12} sm={12} sx={{justifyContent:"center",marginTop:"-32%",
           alignItems:"center",textAlign:"center",marginLeft:"42%",
           }}>
            <img src={DayPicker} alt="DayPicker" style={{height:"50%",width:"50%",
          border:"0px solid white ",borderRadius:"35px",bgcolor:"#FFF"}}/>
           </Grid>
          ...
          >
            ...
            InputProps={{
             ...
             >
              ...
              <img src={search} alt="search" /> </Grid> */}
            </TextField>
          </Grid>
