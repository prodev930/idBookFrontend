...
import recentpicker from '../Images/recentpicker.png';
...
{/* <Grid item xs={12} sm={12} sx={{justifyContent:"center",marginTop:"2%",
          ...
          >
           ...
           {/* <Grid xs={12} sm={12} sx={{marginTop:"-33%",marginRight:"22%",
           justifyContent:"center",textAlign:"center",alignItems:"center"}}>
            <Button variant="contained" sx={{
             ...
             textAlign:"left",
              ...
              <Typography variant="subtitle1" sx={{marginTop:"5%",fontFamily:"inherit"}}>
              <b> Recent Searches</b> <br/> 
               <p><AccessAlarmIcon /> Hamptons, Suffolk County, NY <br/></p>
               <p><AccessAlarmIcon /> Las Vegas, NV, United States <br/> </p>
               <p><AccessAlarmIcon /> Ueno, Taito, Tokyo <br/> </p>
               <p><AccessAlarmIcon /> Ikebukuro, Toshima, Tokyo</p>
              </Typography>
           ...
           alignItems:"center",textAlign:"center",marginRight:"30%",
           }}>
            <img src={recentpicker} alt="recentpicker" style={{height:"35%",width:"40%",
